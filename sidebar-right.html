...
<html>
<head>
<title>Kotlin | Corklow | Pages | Sidebar Right</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<meta name="description" content="Kotlin e статично-типизиран програмен език, който върви на Java виртуална машина и може да бъде компилиран заедно с JavaScript source code или да използва компилатор с LLVM* структура.">
<meta name="keywords" content="Kotlin e статично-типизиран програмен език, който върви на Java виртуална машина и може да бъде компилиран заедно с JavaScript source code или да използва компилатор с LLVM* структура.">
...
- И разбира се Android Studio.
	  ...
	  <div id="comments">
        ...
        <ul>
          <li>
            <article>
              <header>
                <figure class="avatar"><img src="images/demo/avatar.png" alt="user1 avatar"></figure>
                <address>
                By <a href="#">Jivko</a>
                </address>
          ...
          <li>
            <article>
              <header>
                <figure class="avatar"><img src="images/demo/avatar.png" alt="user2 avatar"></figure>
                <address>
                By <a href="#">Georgi</a>
                </address>
                <time datetime="2045-04-06T08:15+00:00">Friday, 6<sup>th</sup> April 2045 @08:15:00</time>
          ...
          <li>
            <article>
              <header>
                <figure class="avatar"><img src="images/demo/avatar.png" alt="user3 avatar"></figure>
                <address>
                By <a href="#">Vito</a>
                </address>
                <time datetime="2045-04-06T08:15+00:00">Friday, 6<sup>th</sup> April 2045 @08:15:00</time>
    ...
    <div class="sidebar one_quarter"> 
      ...
      <div class="sdb_holder first-sdb_holder">
        <ul>
