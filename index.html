...
<meta name="description" content="В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата с нея с помощта на изчислителна техника (компютри). ">
<meta name="keywords" content="technology, web design, themes">
...
<div class="wrapper bgded overlay">
  <div id="pageintro" class="hoc clear"> 
    <article>
      ...
      <h2 class="heading orange"><span class="block lightblue">Бъдещето е в </span> НАС !</h2>
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="firstp">Понятието <strong>„информационни технологии“</strong> в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="firstp">В центъра на <strong>информационните технологии</strong></strong> е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="firstp"><strong>Информационните технологии</strong> използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace2">&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
    <nav>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay second" >
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="placeholder"></a>
        ...
        <hr>
        <p class="firstp">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
        <p class="nospace"><a href="#">Read More &raquo;</a></p>
      </article>
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="placeholder"></a>
        <h4 class="nospace btmspace-10 font-x1 uppercase">Езикът C# и платформата .NET</h4>
        <nav>
        <ul class="nospace btmspace-10 group font-xs">
          <li class="fl_left">
        ...
        <hr>
        <p class="firstp">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt="placeholder"></a>
        ...
        <hr>
        <p class="firstp">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
